...
class PortRuntime:
    ...
    def bootstrap_session(self, prompt: str, limit: int = 5) -> RuntimeSession:
        ...
        if 'Prompt:' not in turn_result.output:
            turn_result = TurnResult(
                ...
                matched_commands=turn_result.matched_commands,
                matched_tools=turn_result.matched_tools,
                permission_denials=turn_result.permission_denials,
